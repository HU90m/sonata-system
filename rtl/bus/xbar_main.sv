...
module xbar_main (
  ...
  output tlul_pkg::tl_h2d_t tl_gpio_pmodc0_o,
  input  tlul_pkg::tl_d2h_t tl_gpio_pmodc0_i,
  ...
  assign tl_pinmux_o = tl_s1n_29_ds_h2d[3];
  assign tl_s1n_29_ds_d2h[3] = tl_pinmux_i;

  assign tl_system_info_o = tl_s1n_29_ds_h2d[4];
  assign tl_s1n_29_ds_d2h[4] = tl_system_info_i;

  assign tl_rgbled_ctrl_o = tl_s1n_29_ds_h2d[5];
  assign tl_s1n_29_ds_d2h[5] = tl_rgbled_ctrl_i;

  assign tl_hw_rev_o = tl_s1n_29_ds_h2d[6];
  assign tl_s1n_29_ds_d2h[6] = tl_hw_rev_i;

  assign tl_xadc_o = tl_s1n_29_ds_h2d[7];
  assign tl_s1n_29_ds_d2h[7] = tl_xadc_i;

  assign tl_timer_o = tl_s1n_29_ds_h2d[8];
  assign tl_s1n_29_ds_d2h[8] = tl_timer_i;

  assign tl_gpio_board0_o = tl_s1n_29_ds_h2d[9];
  assign tl_s1n_29_ds_d2h[9] = tl_gpio_board0_i;

  assign tl_gpio_rph0_o = tl_s1n_29_ds_h2d[10];
  assign tl_s1n_29_ds_d2h[10] = tl_gpio_rph0_i;

  assign tl_gpio_ah0_o = tl_s1n_29_ds_h2d[11];
  assign tl_s1n_29_ds_d2h[11] = tl_gpio_ah0_i;

  assign tl_gpio_pmod00_o = tl_s1n_29_ds_h2d[12];
  assign tl_s1n_29_ds_d2h[12] = tl_gpio_pmod00_i;

  assign tl_gpio_pmod10_o = tl_s1n_29_ds_h2d[13];
  assign tl_s1n_29_ds_d2h[13] = tl_gpio_pmod10_i;

  assign tl_gpio_pmodc0_o = tl_s1n_29_ds_h2d[14];
  assign tl_s1n_29_ds_d2h[14] = tl_gpio_pmodc0_i;

  assign tl_pwm0_o = tl_s1n_29_ds_h2d[15];
  assign tl_s1n_29_ds_d2h[15] = tl_pwm0_i;

  assign tl_uart0_o = tl_s1n_29_ds_h2d[16];
  assign tl_s1n_29_ds_d2h[16] = tl_uart0_i;

  assign tl_uart1_o = tl_s1n_29_ds_h2d[17];
  assign tl_s1n_29_ds_d2h[17] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_29_ds_h2d[18];
  assign tl_s1n_29_ds_d2h[18] = tl_uart2_i;

  assign tl_i2c0_o = tl_s1n_29_ds_h2d[19];
  assign tl_s1n_29_ds_d2h[19] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_29_ds_h2d[20];
  assign tl_s1n_29_ds_d2h[20] = tl_i2c1_i;

  assign tl_spi0_o = tl_s1n_29_ds_h2d[21];
  assign tl_s1n_29_ds_d2h[21] = tl_spi0_i;

  assign tl_spi1_o = tl_s1n_29_ds_h2d[22];
  assign tl_s1n_29_ds_d2h[22] = tl_spi1_i;

  assign tl_spi2_o = tl_s1n_29_ds_h2d[23];
  assign tl_s1n_29_ds_d2h[23] = tl_spi2_i;

  assign tl_spi3_o = tl_s1n_29_ds_h2d[24];
  assign tl_s1n_29_ds_d2h[24] = tl_spi3_i;
  ...
  always_comb begin
    ...
    if ((tl_s1n_29_us_h2d.a_address &
      ...
      dev_sel_s1n_29 = 5'd13;
                  ...
                  ~(ADDR_MASK_GPIO_PMODC0)) == ADDR_SPACE_GPIO_PMODC0) begin
  ...
  tlul_socket_1n #(
    .HReqDepth (4'h0),
    .HRspDepth (4'h0),
    .DReqPass  (27'h3e00157),
    .DRspPass  (27'h3e00157),
    .DReqDepth (108'h100000111111111111010101000),
    .DRspDepth (108'h100000111111111111010101000),
    .N         (27)
  ) u_s1n_29 (
    .clk_i        (clk_sys_i),
    .rst_ni       (rst_sys_ni),

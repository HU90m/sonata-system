...
(
  ...
  output tlul_pkg::tl_h2d_t tl_gpio_board_o[GPIO_BOARD_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_board_i[GPIO_BOARD_NUM],
  output tlul_pkg::tl_h2d_t tl_gpio_rph_o[GPIO_RPH_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_rph_i[GPIO_RPH_NUM],
  output tlul_pkg::tl_h2d_t tl_gpio_ah_o[GPIO_AH_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_ah_i[GPIO_AH_NUM],
  output tlul_pkg::tl_h2d_t tl_gpio_pmod0_o[GPIO_PMOD0_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_pmod0_i[GPIO_PMOD0_NUM],
  output tlul_pkg::tl_h2d_t tl_gpio_pmod1_o[GPIO_PMOD1_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_pmod1_i[GPIO_PMOD1_NUM],
  output tlul_pkg::tl_h2d_t tl_gpio_pmodc_o[GPIO_PMODC_NUM],
  input  tlul_pkg::tl_d2h_t tl_gpio_pmodc_i[GPIO_PMODC_NUM],
  ...
  xbar_main xbar (
    ...
    .tl_gpio_board0_o        (tl_gpio_board_o[0]),
    .tl_gpio_board0_i        (tl_gpio_board_i[0]),
    .tl_gpio_rph0_o        (tl_gpio_rph_o[0]),
    .tl_gpio_rph0_i        (tl_gpio_rph_i[0]),
    .tl_gpio_ah0_o        (tl_gpio_ah_o[0]),
    .tl_gpio_ah0_i        (tl_gpio_ah_i[0]),
    .tl_gpio_pmod00_o        (tl_gpio_pmod0_o[0]),
    .tl_gpio_pmod00_i        (tl_gpio_pmod0_i[0]),
    .tl_gpio_pmod10_o        (tl_gpio_pmod1_o[0]),
    .tl_gpio_pmod10_i        (tl_gpio_pmod1_i[0]),
    .tl_gpio_pmodc0_o        (tl_gpio_pmodc_o[0]),
    .tl_gpio_pmodc0_i        (tl_gpio_pmodc_i[0]),

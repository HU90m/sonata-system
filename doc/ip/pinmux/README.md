...
| 0x840 | `gpio[2].ios[0]` | 0, `pmod0_0` |
| 0x841 | `gpio[2].ios[1]` | 0, `pmod0_1` |
| 0x842 | `gpio[2].ios[2]` | 0, `pmod0_2` |
| 0x843 | `gpio[2].ios[3]` | 0, `pmod0_3` |
| 0x844 | `gpio[2].ios[4]` | 0, `pmod0_4` |
| 0x845 | `gpio[2].ios[5]` | 0, `pmod0_5` |
| 0x846 | `gpio[2].ios[6]` | 0, `pmod0_6` |
| 0x847 | `gpio[2].ios[7]` | 0, `pmod0_7` |
| 0x848 | `gpio[2].ios[8]` | 0, `pmod1_0` |
| 0x849 | `gpio[2].ios[9]` | 0, `pmod1_1` |
| 0x84a | `gpio[2].ios[10]` | 0, `pmod1_2` |
| 0x84b | `gpio[2].ios[11]` | 0, `pmod1_3` |
| 0x84c | `gpio[2].ios[12]` | 0, `pmod1_4` |
| 0x84d | `gpio[2].ios[13]` | 0, `pmod1_5` |
| 0x84e | `gpio[2].ios[14]` | 0, `pmod1_6` |
| 0x84f | `gpio[2].ios[15]` | 0, `pmod1_7` |
...
| 0x862 | `uart[2].rx` | 1, `rph_rxd0`, `pmod0_2` |
| 0x863 | `uart[3].rx` | 1, `ah_tmpio0`, `mb8`, `pmod1_2` |
| 0x864 | `uart[4].rx` | 1, `rs232_rx` |
| 0x865 | `spi[0].rx` | 0, `appspi_d1` |
| 0x866 | `spi[1].rx` | 0, 0 |
| 0x867 | `spi[2].rx` | 0, `ethmac_cipo` |
| 0x868 | `spi[3].rx` | 0, `rph_g9_cipo`, `ah_tmpio12`, `pmod0_2`, `microsd_dat0` |
| 0x869 | `spi[4].rx` | 0, `rph_g19_cipo`, `mb3`, `pmod1_2` |
